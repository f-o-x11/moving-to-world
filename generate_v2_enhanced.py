#!/usr/bin/env python3
"""
Enhanced V2 City Page Generator
Fixes all issues from V1 and adds new features
"""
...
def generate_city_page(city: dict, template: str, base_dir: Path):
    ...
    climate = get_climate_description(latitude)
    ...
    replacements = {
        ...
        '{{AVG_RENT}}': avg_rent,
        '{{WALK_SCORE}}': '65',  # Default walk score
...
def main():
    ...
    print(f"Generating {len(cities)} city pages with V2 enhancements...")
    print("="*80)
    ...
    for i, city in enumerate(cities, 1):
        try:
            generate_city_page(city, template, base_dir)
            success_count += 1
